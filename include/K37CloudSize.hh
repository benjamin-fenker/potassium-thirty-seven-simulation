///
/// \file <K37CloudSize .hh> 
///
/// \brief <This class definines Neutral 37Ar that is used for shakeoff electron decay> 
...
public:
	...
	~K37CloudSize();
	void makeEvent();
	G4double xFinal(){return endX;};
	G4double yFinal(){return endY;};
	G4double zFinal(){return endZ;};
