...
class K37AllPossibleEventInformation {
 public:
  explicit K37AllPossibleEventInformation(std::string _filename);
  ...
  void setShouldEventInformationBeRecorded() {
    shouldEventInformationBeRecorded= true;
  };
  // G4double get(){return;};
  // void set(G4double _){=_;};
  // G4double get(){return;};
  // void set(G4double _){=_;};
  G4double getOriginalTheta() {
    return originalTheta;
  };
  void setOriginalTheta(G4double _originalTheta) {
    originalTheta = _originalTheta;
  };

  G4bool getIsTheVertexSet() {
    return IsTheVertexSet;
  };
  void setIsTheVertexSetToTrue() {
    IsTheVertexSet= true;
  };

  G4bool getGammaFiredStripDetectorPlusZ() {
    return gammaFiredStripDetectorPlusZ;
  };
  void setGammaFiredStripDetectorPlusZToTrue() {
    gammaFiredStripDetectorPlusZ= true;
  };

  G4bool getGammaFiredStripDetectorMinusZ() {
    return gammaFiredStripDetectorMinusZ;
  };
  void setGammaFiredStripDetectorMinusZToTrue() {
    gammaFiredStripDetectorMinusZ= true;
  };

  G4bool getGammaFiredScintillatorMinusZ() {
    return gammaFiredScintillatorMinusZ;
  };
  void setGammaFiredScintillatorMinusZToTrue() {
    gammaFiredScintillatorMinusZ= true;
  };

  G4bool getGammaFiredScintillatorPlusZ() {
    return gammaFiredScintillatorPlusZ;
  };
  void setGammaFiredScintillatorPlusZToTrue() {
    gammaFiredScintillatorPlusZ= true;
  };

  G4bool getPlusZDetectorsFired() {
    return PlusZDetectorsFired;
  };
  void setPlusZDetectorsFiredToTrue() {
    PlusZDetectorsFired= true;
  };

  G4ThreeVector getVertexPosition() {
    return vertexPosition;
  };
  void setVertexPosition(G4ThreeVector _vertexPosition) {
    vertexPosition= _vertexPosition;
  };

  G4ThreeVector getDaughterMomentum() {
    return daughterMomentum;
  };
  void setDaughterMomentum(G4ThreeVector _daughterMomentum) {
    daughterMomentum= _daughterMomentum;
  };
  G4double getTotalEnergyInScintillator() {
    return totalEnergyInScintillator;
  };
  void setTotalEnergyInScintillator(G4double _totalEnergyInScintillator) {
    totalEnergyInScintillator= _totalEnergyInScintillator;
  };

  G4double getTotalEnergyInStripDetector() {
    return totalEnergyInStripDetector;
  };
  void setTotalEnergyInStripDetector(G4double _totalEnergyInStripDetector) {
    totalEnergyInStripDetector = _totalEnergyInStripDetector;
  };

  G4double getMetaStableTimeOfDeath() {
    return metaStableTimeOfDeath;
  };
  void setMetaStableTimeOfDeath(G4double _metaStableTimeOfDeath) {
    metaStableTimeOfDeath= _metaStableTimeOfDeath;
  };

  G4double getStartStripDetectorTime() {
    return stripDetectorStartTime;
  };
  void setStartStripDetectorTime(G4double _stripDetectorStartTime) {
    stripDetectorStartTime= _stripDetectorStartTime;
  };

  G4bool getIsThisAnAcceptedEvent() {
    return acceptedEvent;
  };
  void setThisIsAnAccepterEvent() {
    acceptedEvent= true;
  };
 ...
 private:
  ...
  // value of 1 means that it is the plus Z telescope fired 0 is minus z
  G4bool PlusZDetectorsFired;
