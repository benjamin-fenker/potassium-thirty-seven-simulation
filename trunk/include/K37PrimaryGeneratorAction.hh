...
{
  public:
	K37PrimaryGeneratorAction(K37DetectorConstruction*, K37AllPossibleEventInformation*, K37EventGenerator*);
  ...
  private:
	...
	K37AllPossibleEventInformation* EventInformation;   //Container that gathers all of the event information from the most convient sources. 
	G4ThreeVector v;
