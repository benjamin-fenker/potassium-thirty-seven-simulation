...
:Real_1(0), Real_0(0), Imaginary_1(0), NA(0), Z1(0), TH(0), GR(0), GI(0), T(0), GR1(0), GI1(0), TH1(0), SR(0), SI(0), Z2(0), TH2(0), G0(0)
...
void K37ComplexGammaFunction::computeK37ComplexGammaFunction(char choice, double Real, double Imaginary)
{
	...
	//G4cout<< std::boolalpha<< (Real < 0.0) << G4endl;
		if (Imaginary == 0.0 && (Real == int(Real)) && Real < 0.0 )
		{
...
//	   G4cout<< GR1<<"   "<< GI1<<"   "<< GR<<"   " << GI<< G4endl;
        ...
        if (Real_1<0.0)
	{
	   ...
	   //G4cout<< TH2<< "  "<< GR<< " "<< GI<< " "<< Real<< " "<< Imaginary  << G4endl;
//	   G4cout<< choice<<" "<< Real<< " "<< Imaginary  << G4endl;
	}
	    
	if ( choice=='l')
	{	
	   G4cout<< choice<<" "<< Real<< " "<< Imaginary <<" "<< GR<<" "<< GI << G4endl;
	}
...
double K37ComplexGammaFunction::realPart(char choice, double Real, double Imaginary)
{
...
double K37ComplexGammaFunction::absSquaredComplexGamma(char choice, double Real, double Imaginary)
{
